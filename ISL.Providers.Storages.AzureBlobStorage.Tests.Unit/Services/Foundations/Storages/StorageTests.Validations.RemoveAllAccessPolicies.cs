...
namespace ISL.Providers.Storages.AzureBlobStorage.Tests.Unit.Services.Foundations.Storages
{
    public partial class StorageTests
    {
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionOnRemoveAccessPolicyIfArgumentsInvalidAsync(
            string invalidText)
        {
            // given
            ...
            ValueTask removeAccessPolicyTask =
                this.storageService.RemoveAllAccessPoliciesAsync(invalidContainer);
