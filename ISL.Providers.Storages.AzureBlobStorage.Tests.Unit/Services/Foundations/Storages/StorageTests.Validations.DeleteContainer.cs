...
namespace ISL.Providers.Storages.AzureBlobStorage.Tests.Unit.Services.Foundations.Storages
{
    public partial class StorageTests
    {
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionOnDeleteContainerIfArgumentsInvalidAsync(string invalidText)
        {
            // given
            ...
            ValueTask createContainerTask =
                this.storageService.DeleteContainerAsync(invalidContainer);
