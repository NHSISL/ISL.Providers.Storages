    ...
    public partial class StorageTests
    {
        ...
        public async Task ShouldThrowValidationExceptionOnCreateAccessPolicyIfArgumentsInvalidAsync(string invalidText, List<string> invalidList)
        {
            ...
            ValueTask createAccessPolicyTask =
                this.storageService.CreateAndAssignAccessPolicyToContainerAsync(invalidContainer, invalidPolicyNames);
        ...
        public async Task ShouldThrowValidationExceptionOnCreateAccessPolicyIfPolicyNamesInvalidAsync()
        {
            ...
            // when
            ValueTask createAccessPolicyTask =
                this.storageService.CreateAndAssignAccessPolicyToContainerAsync(inputContainer, invalidPolicyNames);
