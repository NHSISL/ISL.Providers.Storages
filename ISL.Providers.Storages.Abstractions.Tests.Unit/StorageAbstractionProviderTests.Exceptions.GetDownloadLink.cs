...
namespace ISL.Providers.Storage.Abstractions.Tests.Unit
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnGetDownloadLinkWhenTypeIStorageValidationException()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnGetDownloadLinkWhenTypeIStorageDependencyValidationException()
        {
            // given
            var someException = new Xeption();
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnGetDownloadLinkWhenTypeIStorageDependencyException()
        {
            // given
            var someException = new Xeption();
            ...
            StorageProviderDependencyException actualStorageDependencyProviderException =
                await Assert.ThrowsAsync<StorageProviderDependencyException>(testCode: getDownloadLinkTask.AsTask);
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnGetDownloadLinkWhenTypeIStorageServiceException()
        {
            // given
            var someException = new Xeption();
            ...
            StorageProviderServiceException actualStorageServiceProviderException =
                await Assert.ThrowsAsync<StorageProviderServiceException>(testCode: getDownloadLinkTask.AsTask);
        ...
        [Fact]
        public async Task ShouldThrowUncatagorizedServiceExceptionOnGetDownloadLinkWhenTypeIsNotExpected()
        {
            // given
            var someException = new Xeption();
